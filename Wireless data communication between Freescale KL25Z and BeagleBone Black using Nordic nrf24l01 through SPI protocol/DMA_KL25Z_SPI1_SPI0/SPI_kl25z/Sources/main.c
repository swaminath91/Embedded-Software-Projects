/*
 * File:		main.c
 * Purpose:		Main process between spi and kl25z with dma
 *
 */
#include "MKL25Z4.H"                  //MKL24Z4 library file
#include "common.h"                  //common.h header file for CMSIS
...
int main (void)              //main
{
	...
	while(1)
	{
		spi1_dma_master_spi0_slave();    //calling spi1 master and spi0 slave function
